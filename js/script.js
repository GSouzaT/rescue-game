...
function start() { // Inicio da função start()
	...
	function placar() {
		...
		$("#placar").html(`<h2> Pontos: ${pontos} Salvos: ${salvos} Perdidos: ${perdidos} Recorde: ${recorde} </h2>`);
	}
	...
	function moveJogador() {
		...
		if (jogo.pressionou[tecla.S] && topo<=420) {	
			$("#jogador").css("top",topo+10);	
		}
